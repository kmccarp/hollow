...
public class TypeFilterTest {
    private static final Collection<Object[]> typeCases = asList(
            ...
            c("exclude all: hierarchy",   l(Alpha.class), com.netflix.hollow.core.read.filter.TypeFilter.Builder::excludeAll, none()),
            c("exclude all: collections", l(Omega.class), com.netflix.hollow.core.read.filter.TypeFilter.Builder::excludeAll, none()),
