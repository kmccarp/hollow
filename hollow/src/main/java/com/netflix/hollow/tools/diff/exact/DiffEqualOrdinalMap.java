...
public class DiffEqualOrdinalMap {
    ...
    private final OrdinalIdentityTranslator fromIdentityTranslator = ordinal -> getIdentityFromOrdinal(ordinal);

    private final OrdinalIdentityTranslator toIdentityTranslator = ordinal -> getIdentityToOrdinal(ordinal);
