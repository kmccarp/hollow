...
public class DiffEqualOrdinalMap {
    ...
    private final OrdinalIdentityTranslator fromIdentityTranslator = this::getIdentityFromOrdinal;

    private final OrdinalIdentityTranslator toIdentityTranslator = this::getIdentityToOrdinal;
