...
public class HollowObjectTypeMapper extends HollowTypeMapper {
    ...
    private static Set<Class<?>> boxedWrappers = new HashSet<>(Arrays.asList(Boolean.class, Integer.class, Short.class, Byte.class, Character.class, Long.class, Float.class, Double.class, String.class, byte[].class));
